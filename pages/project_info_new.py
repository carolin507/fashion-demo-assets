...
def render_project_info_new():
    ...
    css = dedent(
        ...
        .lp-shell { padding:24px 0 56px; }
        .container { width:100%; display:flex; flex-direction:column; gap:40px; overflow:visible; }
        .card { background:var(--card); border-radius:14px; padding:30px 26px; border:1px solid rgba(0,0,0,0.02); box-shadow:0 14px 30px rgba(28,12,4,0.08); }
        ...
        /* hero */
        .hero { display:grid; grid-template-columns:1.05fr 0.95fr; gap:18px; align-items:center; padding:32px; border-radius:16px;
        ...
        .soft { background:#fff; border:1px solid var(--line); border-radius:12px; padding:16px; box-shadow:0 10px 22px rgba(87,50,20,0.05); }
        ...
        .engine-head { display:flex; align-items:center; justify-content:center; gap:10px; margin-bottom:14px; }
        ...
        .flow-step { padding:12px; border-radius:12px; border:1px dashed rgba(0,0,0,0.07); background:#fff; box-shadow:0 10px 20px rgba(50,30,10,0.05); display:flex; gap:10px; align-items:center; }
        ...
        .mini-process { display:grid; grid-template-columns:repeat(5, minmax(0,1fr)); gap:12px; align-items:center; justify-items:center; text-align:center; }
        .mini-card { background:#fff; border:1px solid var(--line); border-radius:10px; padding:10px; box-shadow:0 8px 18px rgba(60,30,10,0.05); }
        .mini-process .arrow { color:var(--muted); font-weight:700; font-size:16px; }
        /* strip */
        ...
        /* dark panel */
        .dark-section { background:linear-gradient(135deg,#1b0f12,#381a1f 55%,#731f33); color:#fff7ee; border-radius:16px; padding:26px; box-shadow:0 22px 48px rgba(16,0,8,0.3); }
        .dark-section .engine-head { margin-bottom:10px; }
        .dark-grid { display:grid; grid-template-columns:1fr 0.85fr; gap:16px; align-items:center; }
        ...
        /* tech */
        .tech-grid { display:grid; grid-template-columns:repeat(auto-fit,minmax(300px,1fr)); gap:14px; }
        .tech-card { background:#fff; border-radius:12px; padding:16px; border:1px solid var(--line); box-shadow:0 10px 22px rgba(50,30,10,0.07); }
        ...
        /* CTA */
        .cta-footer { background:#e3004f; color:#fff7ee; padding:26px; border-radius:14px; box-shadow:0 18px 38px rgba(180,0,50,0.28); display:grid; grid-template-columns:1fr 1fr; gap:16px; align-items:center; }
        ...
        <div class="lp-shell">
          <div class="container">
            ...
            <section class="card engine-block">
              ...
              <div class="soft" style="margin-top:18px; background:#f1ede8; text-align:center;">
                <h3 style="margin-bottom:10px;">智慧之眼：AI 如何理解時尚</h3>
                <div class="img-frame" style="margin:0 auto 16px; background:#fff; max-width:520px;"><img src="{info_base}/pic_process.png" alt="AI process"></div>
                ...
                <div style="margin-top:10px; text-align:center; font-family:monospace; background:#e8e1d8; padding:6px 10px; border-radius:10px; display:inline-block;">['blue', 'solid', 'jeans', 'casual']</div>
              </div>
            </section>
            ...
            <section class="dark-section engine-block">
              <div class="engine-head">
                ...
                <h2 style="margin:0; color:#fff7ee;">為品牌賦能 · 商業智慧儀表板</h2>
              </div>
              <div class="dark-grid">
                <div>
                ...
                <div class="insights" style="justify-self:center; width:100%; max-width:420px;">
    ...
    components.html(css + html, height=7200, scrolling=True)
